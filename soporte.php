...
<head>
    ...
    <meta property="og:title" content="Soporte | UCAP Aguascalientes">
    ...
    <title>Soporte | Capullitos</title>
</head>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center mt-5 mb-5">
                    <div class="col-12 col-md-11 mb-5">
                        <h2>SOPORTE</h2>
                        <p>Los siguientes medios son enlaces directos para ponerte en contácto con el equipo de desarrollo de <b>datallizer</b>, recuerda hacer buen uso de ellos, unicamente podrás reportar fallas relacionadas al funcionamiento del sitio web cómo: Alta, baja o actualizacion de usuarios, alummos, servicios, formularios, noticas, error al mostrar datos y mal funcionamiento o comportamientos no esperados en el diseño de algún componente.</p>
                    </div>
